...
{
	currentSection = $('#home');
	$('#btn-home').click(onClickBtnHome);
	$('#btn-about').click(onClickBtnAbout);
    $('#btn-skills').click(onClickBtnSkills);
    $('#btn-gallery').click(onClickBtnGallery);
    $('#btn-contact').click(onClickBtnContact);
...
function onClickBtnGallery() {
	gotoSection('gallery');    
}

function onClickBtnContact() {
	gotoSection('contact');    
}
